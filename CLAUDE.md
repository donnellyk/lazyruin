...
`scripts/keybinding-test.sh` runs a comprehensive keyboard shortcut smoke test (67 assertions across 74 sections covering all TUI contexts). Keep this script up to date when adding/changing keybindings.
